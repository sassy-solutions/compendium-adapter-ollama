...
namespace Compendium.Adapters.Ollama.Tests.Options;
...
{
    [Fact]
    public void OllamaOptions_Defaults_AreSensible()
    {
        // Arrange / Act
    ...
    public void OllamaOptions_DataAnnotations_ValidateAsExpected(
        string baseUrl,
        string apiKey,
        bool expectedValid)
    {
        // Arrange
        var options = new OllamaOptions { BaseUrl = baseUrl, ApiKey = apiKey };
    ...
    [Fact]
    public void OllamaOptions_SectionName_IsCanonical()
    {
        // Assert
        OllamaOptions.SectionName.Should().Be("Compendium:Adapters:Ollama");
    }
}
